/**
 * login.js — Driver login page controller
 * Mirrors rider/scripts/login.js but sets role='driver' on auth.login().
 */
...
resendBtn.addEventListener('click', async () => {
  ...
  otpBoxes.forEach((b) => { b.value = ''; b.classList.remove('otp-box--filled'); });
...
form.addEventListener('submit', async (e) => {
  ...
  // Driver role
  auth.login('driver', phoneInput.value);
  window.location.replace('./home.html');
});
