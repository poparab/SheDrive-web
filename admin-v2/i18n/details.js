...
export const en = {
  ...
  tripDetail: {
    ...
    newDriverPlaceholder: 'Search by driver name or phone…',
  ...
  sosCase: {
    title: 'SOS case',
    crumb: 'Case',
    notFoundHeading: 'SOS case not found',
    notFoundMessage: 'This SOS case does not exist.',
    backToQueue: 'Back to the queue',

    incidentHeading: 'Incident',
    locationHeading: 'Location at trigger',
    riderHeading: 'Rider',
    driverHeading: 'Driver',
    vehicleHeading: 'Vehicle',
    tripHeading: 'Trip',
    contactsHeading: 'Contacts alerted',
    caseMeta: 'Case',
    resolveHeading: 'Resolution',
    ...
    plate: 'Plate',
    vehicleUnavailable: 'No vehicle on record',
    relationship: 'Relationship',
    delivered: 'Delivered',
    failed: 'Could not deliver',
    noContacts: 'No emergency contacts were saved when this case was raised.',
    linkExpires: 'Live link expired',
    outcome: 'Outcome',
    closedAt: 'Closed at',
    closedBy: 'Closed by',
    resolutionNote: 'Resolution note',
    ...
    // The trip is untouched by an SOS \u2014 say so, or an admin will assume the ride was
    // stopped and act on a trip that in fact completed and settled normally.
    tripUnaffected: 'The trip was not interrupted. An SOS is recorded alongside it.',
    silentNotice: 'Neither occupant was told the other had raised this.',

    suspendRiderLabel: 'Suspend the rider',
    suspendDriverLabel: 'Suspend the driver',
    resolvedBtn: 'Close \u2014 resolved',
    falseAlarmBtn: 'Close \u2014 false alarm',
    hintOpen:
      'Tick either party, both, or neither, then choose how the case closes. A suspension ' +
      'is recorded as the outcome and takes effect immediately. Closing is final \u2014 a ' +
      'closed case is never reopened.',
    hintClosed: 'This case is closed. No further action is available.',

    confirmTitle: 'Close this SOS case',
    confirmDescription:
      'Confirm what is recorded against this case. Any suspension applies immediately and ' +
      'appears on that person\u2019s profile and in the audit log.',
    confirmBtn: 'Close case',
    ...
    noteTooLong: 'Too long \u2014 must be \u2264 500 characters',
    summaryRider: 'The rider will be suspended.',
    summaryDriver: 'The driver will be suspended.',
    summaryBoth: 'Both the rider and the driver will be suspended.',
    summaryNone: 'No account will be suspended.',
    toastClosed: 'SOS case closed.',
  },
};
...
export const ar = {
  ...
  tripDetail: {
    ...
    newDriverPlaceholder: 'ابحثي باسم السائقة أو رقم هاتفها…',
  ...
  sosCase: {
    title: 'حالة طوارئ',
    crumb: 'الحالة',
    notFoundHeading: 'الحالة غير موجودة',
    notFoundMessage: 'حالة الطوارئ هذه غير موجودة.',
    backToQueue: 'العودة إلى القائمة',

    incidentHeading: 'البلاغ',
    locationHeading: 'الموقع عند الطلب',
    riderHeading: 'الراكبة',
    driverHeading: 'السائقة',
    vehicleHeading: 'المركبة',
    tripHeading: 'الرحلة',
    contactsHeading: 'جهات الاتصال المُخطَرة',
    caseMeta: 'الحالة',
    resolveHeading: 'القرار',

    caseId: 'رقم الحالة',
    raisedBy: 'مقدّمة من',
    raisedAt: 'وقت الطلب',
    tripState: 'حالة الرحلة عند الطلب',
    note: 'ما تمّ الإبلاغ عنه',
    ...
    plate: 'رقم اللوحة',
    vehicleUnavailable: 'لا توجد مركبة مسجلة',
    relationship: 'صلة القرابة',
    delivered: 'تم التسليم',
    failed: 'تعذّر التسليم',
    noContacts: 'لم تكن هناك جهات اتصال محفوظة عند إرسال هذا الطلب.',
    ...
    tripUnaffected: 'لم تتوقف الرحلة. يُسجّل طلب الطوارئ بجانبها.',
    silentNotice: 'لم يُبلَّغ أي من الطرفين بأن الآخر أرسل هذا الطلب.',

    suspendRiderLabel: 'إيقاف الراكبة',
    suspendDriverLabel: 'إيقاف السائقة',
    resolvedBtn: 'إغلاق \u2014 تم الحل',
    falseAlarmBtn: 'إغلاق \u2014 إنذار كاذب',
    hintOpen:
      'اختاري أحد الطرفين أو كليهما أو لا أحد، ثم اختاري طريقة الإغلاق. يُسجّل الإيقاف ' +
      'كنتيجة ويسري فورًا. الإغلاق نهائي \u2014 لا تُعاد فتح الحالة.',
    hintClosed: 'هذه الحالة مغلقة. لا توجد إجراءات إضافية.',

    confirmTitle: 'إغلاق حالة الطوارئ',
    confirmDescription:
      'أكّدي ما سيُسجّل على هذه الحالة. يسري أي إيقاف فورًا ويظهر في ملف الشخص وفي سجل التدقيق.',
    confirmBtn: 'إغلاق الحالة',
    noteLabel: 'ملاحظة القرار',
    noteHint: 'اشرحي ما تم التوصل إليه وسبب اختيار هذه النتيجة.',
    noteRequired: 'أضيفي ملاحظة القرار',
    noteTooLong: 'يجب ألا يتجاوز 500 حرف',
    summaryRider: 'سيتم إيقاف الراكبة.',
    summaryDriver: 'سيتم إيقاف السائقة.',
    summaryBoth: 'سيتم إيقاف الراكبة والسائقة معًا.',
    summaryNone: 'لن يتم إيقاف أي حساب.',
    toastClosed: 'تم إغلاق حالة الطوارئ.',
  },
};
