...
export const en = {
  ...
  balances: {
    ...
    colProof: 'Proof',
    proofView: 'View',
    proofAlt: 'Proof attached to this entry',
    ...
    settleDescription:
      ...
      'If she hands back more than she owes, the surplus becomes an available balance.',
    settleAmount: 'Settlement amount (EGP)',
    settleDate: 'Settlement date',
    settleMethod: 'Settlement method',
    settleNote: 'Note',
    settleProof: 'Receipt photo',
    settleProofHint: 'Optional. JPG or PNG, up to 5 MB — the signed receipt or the transfer confirmation.',
    settleDone: 'Settlement recorded.',
    settleDoneSurplus: 'Settlement recorded. She paid {amount} more than she owed — SheDrive now owes her that.',
    errAmountEmpty: 'Enter a settlement amount',
    errAmountInvalid: 'Enter a valid amount',
    errAmountRange: 'Amount must be greater than 0',
    ...
    entryRiderCancellationFeeCredit: 'Rider cancellation fee credit',
    ...
    payoutProof: 'Transfer proof',
    payoutProofHint: 'Optional. JPG or PNG, up to 5 MB — the bank slip or wallet confirmation.',
...
export const ar = {
  ...
  balances: {
    ...
    colProof: 'الإثبات',
    proofView: 'عرض',
    proofAlt: 'الإثبات المرفق بهذه الحركة',
    ...
    settleDescription:
      ...
      'وإذا سلّمت أكثر مما عليها، يتحوّل الفائض إلى رصيد متاح لها.',
    settleAmount: 'مبلغ التسوية (جم)',
    settleDate: 'تاريخ التسوية',
    settleMethod: 'طريقة التسوية',
    settleNote: 'ملاحظة',
    settleProof: 'صورة الإيصال',
    settleProofHint: 'اختياري. JPG أو PNG بحد أقصى 5 ميجابايت — الإيصال الموقّع أو تأكيد التحويل.',
    settleDone: 'تم تسجيل التسوية.',
    settleDoneSurplus: 'تم تسجيل التسوية. دفعت {amount} زيادة عمّا عليها — أصبحت شي درايف مدينة لها بهذا الفائض.',
    errAmountEmpty: 'أدخل مبلغ التسوية',
    errAmountInvalid: 'أدخل مبلغاً صحيحاً',
    errAmountRange: 'يجب أن يكون المبلغ أكبر من 0',
    ...
    entryRiderCancellationFeeCredit: 'رصيد رسوم إلغاء الراكبة',
    ...
    payoutProof: 'إثبات التحويل',
    payoutProofHint: 'اختياري. JPG أو PNG بحد أقصى 5 ميجابايت — إيصال البنك أو تأكيد المحفظة.',
