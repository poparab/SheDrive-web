...
export const SCREENS = [
  ...
  },
  {
    ...
    states: LIST_STATES,
    notes: t('screens.notesBalances'),
  },
  {
    group: t('nav.money'),
    title: t('screens.titleWithdrawals'),
    ...
    states: LIST_STATES,
    notes: t('screens.notesWithdrawals'),
  },
  {
    group: t('nav.money'),
    title: t('screens.titleRiderBalances'),
    file: 'rider-balances.html',
    icon: 'user-star.svg',
    status: 'built',
    track: t('screens.statusBuilt'),
  ...
  {
    group: t('nav.money'),
    title: t('screens.titleSettlements'),
    file: 'settlements.html',
    icon: 'wallet.svg',
    status: 'built',
    track: t('screens.statusBuilt'),
    stories: [[0, '[Admin] Super admin views the settlement day book (FIN-12 — awaiting an ADO id)']],
    states: LIST_STATES,
    notes: t('screens.notesSettlements'),
  },
  {
